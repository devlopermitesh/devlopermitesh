        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="space-y-6 order-1 md:order-2">
            <p className="text-base md:text-lg text-gray-700 leading-relaxed">
              ...
              building scalable web applications. With expertise in modern
            ...
            <p className="text-base md:text-lg text-gray-700 leading-relaxed">
              ...
              Over the years, I've honed my skills in React, Next.js, Node.js,
              and various databases. I believe in writing clean, maintainable
            ...
            <p className="text-base md:text-lg text-gray-700 leading-relaxed">
              ...
              developer community. Let's connect and build something amazing
              together!
            </p>
          </div>
        </div>
